...
nsmp <- 100000
params_initial_3d <- c(0.5, 1, 5) #explain why you chose this 
...
# Open a graphics window with 3 panels (optional)
par(mfrow=c(2,2))

# Plot marginal density for delta
plot(density(delta_samples),
     main = "Posterior Density of delta",
     xlab = "delta")

# Plot marginal density for sigma
plot(density(sigma_samples),
     main = "Posterior Density of sigma",
     xlab = "sigma")

# Plot marginal density for beta
plot(density(beta_samples),
     main = "Posterior Density of beta",
     xlab = "beta")
...
```{r}
plot(
  posterior_samples3d[, "delta"],
  posterior_samples3d[, "beta"],
  xlab = "delta",
  ylab = "beta",
  main = "Joint Posterior Samples: delta vs beta",
  pch = 16, cex = 0.5
)
